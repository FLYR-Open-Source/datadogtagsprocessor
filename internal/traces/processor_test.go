...
// mockConsumer implements config.Consumer[ptrace.Traces] without Shutdown,
...
func (m *mockConsumer) Consume(context.Context, ptrace.Traces, config.CompiledStatement) error {
	return m.consumeErr
}
